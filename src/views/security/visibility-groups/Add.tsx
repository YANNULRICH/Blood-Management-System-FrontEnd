...
const Add = () => {
    ...
    const onSubmit: SubmitHandler<FormType> = (data) => {
        ...
        csuClient.security.visibilityGroups.create(submitData)
            .then((resp) => {
                NotificationManager.success(globalT('security.visibility.management.add.success'))
                ...
                <div className='row'>
                    <div className='col-12'>
                        <Card>
                            <CardHeader>
                                <CardTitle tag='h3'>
                                    <IntlMessages id='security.visibility.management.add' />
                                </CardTitle>
                            </CardHeader>
                            <CardBody>
